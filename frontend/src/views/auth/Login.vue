<template>
  <div class="login-layout">
    ...
    <div v-if="showHeaderLinks" class="header-links">
      ...
      <div class="form-panel">
        ...
        <div class="form-card" v-if="!isRegisterMode">
          <div class="form-header">
            ...
            <p v-if="showRegisterEntry" class="form-hint">{{ $t('auth.loginHint') }}</p>
          </div>
          ...
          <div class="form-content">
            <t-form ref="formRef" :data="formData" :rules="formRules" @submit="handleLogin" layout="vertical">
              ...
              <div class="register-cta" v-if="showRegisterEntry">
...
const showHeaderLinks = computed(() => route.path !== '/login')
const showRegisterEntry = computed(() => registrationEnabled.value && route.path !== '/login')
